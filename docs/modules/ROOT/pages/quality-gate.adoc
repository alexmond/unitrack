...
xref:test-regression.adoc[regression report], and xref:github-checks.adoc[GitHub status]
all use.

== Configuration

All global defaults live under `unitrack.quality-gate` (see xref:configuration.adoc[Configuration]):
