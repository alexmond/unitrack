package io.github.alexmond.unitrack.web;
...
class IngestIntegrationTest {
    ...
    void uploadsResultsAndExposesThemViaApi() throws Exception {
        ...
        mvc.perform(multipart("/api/v1/ingest")
                        .file(new MockMultipartFile("junit", "TEST-Calc.xml", "text/xml", junit))
    ...
    void rejectsUploadWithoutJunitFile() throws Exception {
        mockMvc().perform(multipart("/api/v1/ingest").param("project", "demo"))
